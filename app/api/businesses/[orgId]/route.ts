...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in GET /api/businesses/[orgId]:', error);
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in PATCH /api/businesses/[orgId]:', error);
    return NextResponse.json(
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const result = await deleteBusiness(orgId);
    ...
    console.error('Error in DELETE /api/businesses/[orgId]:', error);
    return NextResponse.json(
