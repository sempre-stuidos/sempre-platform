...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in PATCH /api/businesses/[orgId]/menu-categories/[categoryId]:', error);
    return NextResponse.json(
      { error: 'Failed to update menu category' },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in DELETE /api/businesses/[orgId]/menu-categories/[categoryId]:', error);
    return NextResponse.json(
      { error: 'Failed to delete menu category' },
      { status: 500 }
    );
