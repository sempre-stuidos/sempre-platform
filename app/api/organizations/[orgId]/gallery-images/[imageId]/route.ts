...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in GET /api/organizations/[orgId]/gallery-images/[imageId]:', error);
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in PATCH /api/organizations/[orgId]/gallery-images/[imageId]:', error);
    return NextResponse.json(
      { error: 'Failed to update gallery image' },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    console.error('Error in DELETE /api/organizations/[orgId]/gallery-images/[imageId]:', error);
    return NextResponse.json(
      { error: 'Failed to delete gallery image' },
      { status: 500 }
    );
